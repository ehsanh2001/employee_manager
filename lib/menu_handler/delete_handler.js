...
class DeleteHandler extends Handler {
  ...
  async handleDelete(subMenu) {
    try {
      ...
      console.error("Error in function delete: " + error);
      throw error;
    }
  }
  ...
  async #deleteEmployee() {
    try {
      ...
      error = new Error("Error deleting employee: " + error);
      throw error;
    } finally {
  ...
  async #deleteRole() {
    try {
      ...
      error = new Error("Error deleting role: " + error);
      throw error;
    } finally {
      await UserInput.pressAnyKey();
    }
  ...
  async #deleteDepartment() {
    try {
      ...
      error = new Error("Error deleting department: " + error);
      throw error;
    } finally {
      await UserInput.pressAnyKey();
    }
